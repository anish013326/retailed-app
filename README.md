...
This project is based on the AWS Retail Sample App.
...
This project helped me understand real-world DevOps architecture and deployment strategies.
...
3. **Clone Repository**: `git clone https://github.com/Anish013326/retail-app.git`
...
```sh
git clone https://github.com/Anish013326/retail-app.git
```
...
This project is based on the AWS Retail Sample App provided by Amazon.
